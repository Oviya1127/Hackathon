    ...
    <div className="signup-container">
      ...
      <div className="form-card">
        ...
        <div className="form-group">
          ...
          <input type="number" placeholder="Enter your register number" value={regNo} onChange={(e) => setRegNo(e.target.value)} />
        </div>
...
.title {
  font-size: 2.5rem;
  background: linear-gradient(90deg, #ffcc00, #ff6b00, #ff2600);
...
.form-card:hover {
  box-shadow: 0 0 45px rgba(255, 165, 0, 0.4);
}
...
.problem-section h2, .team-section h2 {
  font-size: 1.3rem;
  color: #ffcc66;
  margin-bottom: 15px;
  text-align: center;
